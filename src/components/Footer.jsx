...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-gray-800 via-gray-900 to-black text-gray-400 py-12 px-6 sm:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-white text-2xl font-bold mb-4">Beyond</h3>
          <p className="text-sm">
            Conectando tecnologia, design e estratégia para levar sua marca além
            do código.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/beyond_system" className="hover:text-white transition">
              <FaInstagram />
            </a>
